...
$verificaritem = mysqli_query($conexion, $query_verificaritem) or die(mysqli_error($conexion));
...
if ((isset($_GET['item'])) && ($_GET['item'] != "")) {
  ...
  if($_GET['file']=='carpetas')
  {
	$deleteGoTo = "carpetas.php?item=".$row_verificaritem['cod_meta_doc'];
	}
	else
	{
    $deleteGoTo = "documentos.php?item=".$row_verificaritem['cod_meta_doc'].'&file='.$_GET['file'];
	}
