...
$editardoc = mysqli_query($conexion, $query_editardoc) or die(mysqli_error($conexion));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "documentos.php?item=".$_POST['item'].'&file='.$_POST['file'];
...
<form class="edite" name="edite" id="edite" role="form">
  <table class="table">
    ...
    <tr valign="baseline">
      <td>
        <a onclick="nre('editdoc','edite','busqueda')" class="btn btn-success">Guardar Cambios</a>
      </td>
    </tr>
  </table>
  <input type="hidden" name="MM_update" value="form1">
  <input type="hidden" name="id_documentos" value="<?php echo $row_editardoc['id_documentos']; ?>">
  <input type="hidden" name="file" value="<?php echo $row_editardoc['cod_carpeta_doc']; ?>">
