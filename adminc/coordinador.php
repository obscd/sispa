...
if (isset($_GET['accion'])) {
  $colname_verlistmetaactivi = $_GET['accion'];
}
mysqli_select_db($conexion, $database_conexion);
...
LEFT JOIN coordinador ON accion.cod_accion=coordinador.cod_quien_necesita)
              ...
              <div class="title_left">
				...
				<h4>
							<div class="btn-group">
                                ...
                                <a href="accion.php?pilar=<?php echo $_GET['pilar']; ?>&programa=<?php echo $_GET['programa']; ?>" data-toggle="tooltip" data-placement="top" title="ir a:" class="btn btn-sm btn-primary">ACCION <?php echo $row_verlistmetaactivi['orden_accion']; ?></a>
