...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <li><a href="#" data-toggle="modal" data-target="#myModal" class="btn btn-block btn-default">Registrar Nuevo Componente</a>
                    </li>
                  </ul>
                    <div class="clearfix"></div>
                  </div>
...
?>
      <tr>
        <td align="center">
        <a href="delcoord.php?del=<?php echo $row_listapilares['cod_pilar']; ?>&a=pilar&b=cod_pilar&c=pilar" data-toggle="tooltip" data-placement="top" title="Eliminar este registro de la LISTA DE PILARES" onclick="if(!confirm('<?php echo $alertborrar; ?>'))return false">
        <i class="fa fa-close fa-2x"></i></a>

        </td>
        <td align="center">
<a class="btn btn-succes" data-toggle='modal' data-target='#option' onClick="ventana('editar','<?php echo $row_listapilares['cod_pilar']; ?>','pop')">
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table class="table">
          ...
          <tr valign="baseline">
            <td bgcolor="#CCCCCC"><input type="text" name="titulo_pilar" class="form-control" required></td>
          </tr>
          <tr valign="baseline">
            <td bgcolor="#CCCCCC">DESCRIPCION</td>
          </tr>
          <tr valign="baseline">
            <td bgcolor="#CCCCCC"><textarea name="descr_pilar" rows="3" class="form-control" required></textarea></td>
          </tr>
		  <tr valign="baseline">
