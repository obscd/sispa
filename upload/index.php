...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>CARGAR IMAGENES AL SISTEMA</h2>
...
<div>
<textarea name="nombre" id="nombre" class="form-control" placeholder="Descripción de la imagen... " required ></textarea>
<!-- <label for="userImage" class="btn btn-primary btn-outlined">Seleccionar imagenes</label> -->
<input name="userImage" id="userImage" type="file" class="demoInputBox form-control" accept="image/*" style="display: show" required/>
</div>
<div><input type="submit" id="btnSubmit" value="SUBIR" class="btnSubmit" /></div>
